    ...
    <table class="providerTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="user" items="${pageInfo.list }" varStatus="status">
            <tr>
                ...
                <td>
                    <span><a class="viewUser" href="javascript:;" userid=${user.id }
                    ...
                    <span><a class="modifyUser" href="javascript:;" userid=${user.id }
                            username=${user.username }><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
                    <span><a class="deleteUser" href="javascript:;" userid=${user.id }
                            username=${user.username }><img src="${pageContext.request.contextPath }/statics/images/schu.png" alt="删除" title="删除"/></a></span>
                </td>
            </tr>
        </c:forEach>
    </table>
